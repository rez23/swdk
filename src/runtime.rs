mod __runtime {
    ...
    pub mod kmdf {
        ...
        use wdk_sys::{
            ...
            WDF_OBJECT_ATTRIBUTES, WDFDEVICE, WDFDRIVER,
            WDFIOTARGET, WDFOBJECT, WDFQUEUE, WDFREQUEST,
        ...
        #[inline]
        pub unsafe fn wdf_request_get_output_buffer(
            request: WDFREQUEST,
            size: usize,
            out_buff: PWDF_MEMORY_DESCRIPTOR,
            read_len: *mut usize,
        ) -> NtResult {
            call_ntstatus_wdf_unsafe_binding!(
