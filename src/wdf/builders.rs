...
use crate::rt::wdk_sys::{
    ...
    WDF_EXECUTION_LEVEL, WDF_IO_QUEUE_CONFIG,
    WDF_IO_QUEUE_DISPATCH_TYPE, WDF_OBJECT_ATTRIBUTES,
    WDF_PNPPOWER_EVENT_CALLBACKS,
    WDF_SYNCHRONIZATION_SCOPE, WDF_TRI_STATE, WDFDRIVER,
    WDFOBJECT,
};
use crate::vals::{
